...
namespace ToolsDal
{
    public class FileBorrowDal
    {
        ...
        {
            return TSQLServer.ExecDt("select * from [FileBorrow] where 1=1 " + strwhere);
        }
        #endregion
        ...
        {
            return TSQLServer.ExecDr("select * from [FileBorrow] where id =" + values[0] + "");
        }
        #endregion
        ...
        {
            return TSQLServer.ExecuteNonQuery("delete [FileBorrow] where  id =" + values[0] + "");
        }
        #endregion
        ...
        {
            return TSQLServer.ExecuteNonQuery("delete [FileBorrow] where id in(" + values + ")");
        }
        #endregion
        ...
        public int Insert(params object[] values)
        {
            ...
            strSql.Append("insert into FileBorrow(");
            strSql.Append("FileEnterID,FileClassID,FileClassName,FileEnterName,BorrowPeople,BorrowUnit,ApproverPeople,ApproverUnit,HandlePeople,BorrowDate,ReturnDate,OperateTime,Remark,UserID,Username,SZQXDM)");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@BorrowUnit", SqlDbType.NVarChar,100),
					new SqlParameter("@ApproverPeople", SqlDbType.NVarChar,50),
					new SqlParameter("@ApproverUnit", SqlDbType.NVarChar,100),
					new SqlParameter("@HandlePeople", SqlDbType.NVarChar,50),
					new SqlParameter("@BorrowDate", SqlDbType.NVarChar,20),
					new SqlParameter("@ReturnDate", SqlDbType.NVarChar,20),
        ...
        public int Update(params object[] values)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update FileBorrow set ");
