<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileDestroyEdit.aspx.cs" Inherits="Manager_DocumentInfor_FileDestroy_FileDestroyEdit" %>
...
<body style="padding: 5px;">
    ...
    <div>
        <div class="navigation">
            <span class="back"><a href="FileDestroyList.aspx">返回列表</a></span><b>您当前的位置： 档案销毁 &gt;销毁操作</b>
        </div>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtSupervisePeople" CssClass="txtbottomstyle" runat="server"></asp:TextBox>
                </td>
                <td width="120" align="right">
                    监督人承办单位：
                </td>
                <td>
                    <asp:DropDownList ID="txtSuperviseUnit" runat="server" CssClass="txtbottomstyle">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtDestroyPeople" CssClass="txtbottomstyle" runat="server"></asp:TextBox>
                </td>
                <td width="120" align="right">
                    销毁地点：
                </td>
                <td>
                    <asp:TextBox ID="txtDestroyAds" CssClass="txtbottomstyle" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td width="120" align="right">
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtDestroyDate" runat="server" CssClass="txtbottomstyle" onclick="WdatePicker();"
