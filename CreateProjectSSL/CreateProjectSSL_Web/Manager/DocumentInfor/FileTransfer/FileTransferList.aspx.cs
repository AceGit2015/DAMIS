...
public partial class Manager_DocumentInfor_FileTransfer_FileTransferList : BasePage
{
  //定义对象实例化
    ...
    private void BindDaSource()
    {
        ...
        PeterPages fenye1 = dal.GetSearch(model, this.Pager1.PageIndex + 1, Pager1.PageSize,LoginUser.CountyId," and yjlx=0 ");
