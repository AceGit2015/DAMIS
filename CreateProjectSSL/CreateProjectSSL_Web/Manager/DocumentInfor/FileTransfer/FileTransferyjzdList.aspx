<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileTransferyjzdList.aspx.cs"
    Inherits="Manager_DocumentInfor_FileTransfer_FileTransferyjzdList" %>
            ...
            <tr>
                <td align="left">
                    ...
                    <asp:DropDownList ID="drop_time" runat="server" CssClass="txtbottomstyle"  Width="80">
                        <asp:ListItem Value="0">移交时间</asp:ListItem>
                        <asp:ListItem Value="1">接收时间</asp:ListItem>
                        <asp:ListItem Value="2">归档时间</asp:ListItem>
                    </asp:DropDownList>：
            ...
            <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand" OnPreRender="rptList_PreRender">
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center">
                            <%# Eval("Jssj", "{0:yyyy-MM-dd}") == "1900-01-01" ? "" : Eval("Jssj", "{0:yyyy-MM-dd}")%>
                        </td>
                        <td align="center">
                            <%# sjztxx(Eval("sjzt").ToString())%>
                        </td>
                        <td align="center">
                            <%#Eval("Jsyy")%>
                        </td>
                        ...
                        <td align="center">
                           <%# Eval("Gdsj", "{0:yyyy-MM-dd}") == "1900-01-01" ? "" : Eval("Gdsj", "{0:yyyy-MM-dd}")%>
                        </td>
                        <td align="center"  style="display:none;">
