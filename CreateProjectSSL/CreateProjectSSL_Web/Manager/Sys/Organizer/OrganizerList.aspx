<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrganizerList.aspx.cs" Inherits="Manager_Sys_Organizer_OrganizerList" %>
    ...
    <div style="margin-left: 10px; margin-top: 10px; margin-bottom: 10px;">
        <table cellpadding="0" cellspacing="0" border="0" width="98%">
            <tr>
                ...
                <td align="right">
                    <a title="新 增" href="OrganizerEdit.aspx" rel="right" class="button green"><span class="icon-botton">
            ...
            <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand" OnPreRender="rptList_PreRender">
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center">
                            <span><a href="OrganizerEdit.aspx?flag=1&id=<%#Eval("ID") %>">查看</a></span>| <span><a
                                href="OrganizerEdit.aspx?id=<%#Eval("ID") %>">编辑</a></span>| <span>
