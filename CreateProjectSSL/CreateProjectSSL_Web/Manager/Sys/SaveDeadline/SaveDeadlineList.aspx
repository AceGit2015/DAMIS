<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SaveDeadlineList.aspx.cs"
    Inherits="Manager_Sys_SaveDeadline_SaveDeadlineList" %>
...
<body style="padding: 5px;">
    ...
    <div class="navigation">
        <span class="add"></span><b>您当前的位置：保管期限 &gt; 列表信息</b>
    </div>
    <%--实现查询条件筛选--%>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="98%">
            <tr>
                <td align="left">
                    ...
                    保管期限：
                    <asp:TextBox ID="txtYearName" CssClass="txtbottomstyle" runat="server">
                    </asp:TextBox>
                      &nbsp;&nbsp; <a id="btnQuery" title="查 询" runat="server" onserverclick="btnQuery_Click"
                        class="button green"></span>查 询</a>
                </td>
                <td align="right">
                    <a title="新 增" href="SaveDeadlineEdit.aspx" rel="right" class="button green"><span
            ...
            <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand" OnPreRender="rptList_PreRender">
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center">
                            <span><a href="SaveDeadlineEdit.aspx?flag=1&id=<%#Eval("ID") %>">查看</a>| </span>
                            <span><a href="SaveDeadlineEdit.aspx?id=<%#Eval("ID") %>">编辑</a>| </span><span>
