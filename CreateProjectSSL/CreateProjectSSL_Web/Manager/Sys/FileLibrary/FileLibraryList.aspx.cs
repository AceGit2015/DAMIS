...
public partial class Manager_Sys_FileLibrary_FileLibraryList : BasePage
{
    //定义对象实例化
    FileLibraryDal dal = new FileLibraryDal();
    ToolsModel.FileLibrary model = new ToolsModel.FileLibrary();
    ...
    {
        //获取查询条件
        model.FileLibraryName = this.GetRequestStr("txtFileLibraryName"); //档案库室名称
        //实现分页，调用分页类
    ...
    protected void lbtnDel_Click(object sender, EventArgs e)
    {
        ...
        new MessageBox(Page).ShowAndJump("批量删除成功!", "FileLibraryList.aspx");
        //操作日志
        LogListDal.Insert(DateTime.Now, "档案库室批量删除", LoginUser.GetUserId,LoginUser.GetUserName);
        this.BindDaSource();
    }
    ...
    protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        switch (e.CommandName.ToLower())
        {
            case "del":
                ...
                new MessageBox(Page).ShowAndJump("删除成功!", "FileLibraryList.aspx");
                //操作日志
                LogListDal.Insert(DateTime.Now, "档案库室删除", LoginUser.GetUserId, LoginUser.GetUserName);
                this.BindDaSource();
                break;
        }
    }
