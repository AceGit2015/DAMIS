<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileLibraryList.aspx.cs" Inherits="Manager_Sys_FileLibrary_FileLibraryList" %>
...
<body style="padding: 5px;">
    ...
    <div class="navigation">
        <%--<span class="add"><a href="OrganizerEdit.aspx">&nbsp;&nbsp;增加承办单位</a></span>--%><b>您当前的位置：
            档案库室 &gt; 列表信息</b>
    </div>
    <%--实现查询条件筛选--%>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="98%">
            <tr>
                <td align="left">
                    ...
                    档案库室名称：
                    <asp:TextBox ID="txtOrganizerName" CssClass="txtbottomstyle" runat="server">
                    </asp:TextBox>
                    &nbsp;&nbsp; <a id="btnQuery" title="查 询" runat="server" onserverclick="btnQuery_Click"
                        class="button green">查 询</a>
                </td>
                <td align="right">
                    <a title="新 增" href="FileLibraryEdit.aspx" rel="right" class="button green"><span class="icon-botton">
            ...
            <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand" OnPreRender="rptList_PreRender">
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center">
                            <%#Eval("FileLibraryName")%>
                        </td>
                        <td align="center">
                            <%#Eval("OrganizerName")%>
                        </td>
                        <td align="center">
                            <span><a href="FileLibraryEdit.aspx?flag=1&id=<%#Eval("ID") %>">查看</a></span>| <span><a
                                href="FileLibraryEdit.aspx?id=<%#Eval("ID") %>">编辑</a></span>| <span>
