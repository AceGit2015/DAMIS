<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AreaList.aspx.cs" Inherits="Manager_Sys_Area_AreaList" %>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="98%">
            <tr>
                <td align="left">
                    ...
                    行政区名称：
                    <asp:TextBox ID="txtAreaName" CssClass="txtbottomstyle" runat="server">
                    </asp:TextBox>
                    &nbsp;&nbsp; <a id="btnQuery" title="查 询" runat="server" onserverclick="btnQuery_Click"
                        class="button green">查 询</a>
                </td>
                <td align="right">
                    <a title="新 增" href="AreaEdit.aspx" rel="right" class="button green"><span class="icon-botton">
            ...
            <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand" OnPreRender="rptList_PreRender">
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center">
                            <span><a href="AreaEdit.aspx?flag=1&id=<%#Eval("ID") %>">查看</a></span>| <span><a
                                href="AreaEdit.aspx?id=<%#Eval("ID") %>">编辑</a></span>| <span>
